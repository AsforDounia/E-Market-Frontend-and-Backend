...
describe("Notification Integration Tests", () => {
    ...
    before(async () => {
        ...
        buyerToken = jwt.sign({ id: buyerUser._id, role: buyerUser.role }, process.env.JWT_SECRET, {
            expiresIn: "1h",
        });
    ...
    describe("GET /notifications", () => {
        ...
        it("should return 401 without authentication token", async () => {
            const response = await request(app).get("/api/v2/notifications").expect(401);
    ...
    describe("PATCH /notifications/:id/read", () => {
        ...
        it("should mark notification as read successfully", async () => {
            ...
            const updatedNotification = await UserNotification.findById(testUserNotification._id);
        ...
        it("should not allow marking another user's notification as read", async () => {
            ...
            const unchangedNotif = await UserNotification.findById(otherUserNotif._id);
